...
# Functions to analyse specific Stan simulations for all interactions ==========
...
#' Analyse all interactions binomial with intercepts and two lambda terms per site
#'
analyse_stan_sim.all_binom_07 <- function(
  spec, data, start, cmdstan_fit, rstan_fit, res_folder
) {
  # Plot posterior distribution and true value of parameters:
  c("alpha", "lambda_bar", "beta", "gamma", "lambda", "sigma_beta", 
