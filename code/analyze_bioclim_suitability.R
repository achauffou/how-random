...
add_suitability_to_interactions <- function(
  ...
  data.table::setcolorder(interactions, c(
    ...
    "sp1_nb_bioclim", "sp1_indiv_suitability", "sp1_indiv_niche_area", 
    "sp1_collec_suitability", "sp1_collec_niche_area", "sp2_fun_group", 
    "sp2_id", "sp2_name", "sp2_kingdom", "sp2_avg_rel_degree", "sp2_is_native", 
    "sp2_origin_status", "sp2_nb_bioclim", "sp2_indiv_suitability", 
